...
* Users who are familiar with code libraries can just clone the repo and run it from their IDE.
* People who are just interested in playing the game can just download the 'Think Fast zip', extract the files, and run the application!
